...
<head>
    <title>Loan Amount | Regional Funds Network</title>
    <meta charset="UTF-8">
            ...
            <div class="row">
                <div class="col-md-5">
                    <div class="banner-left mt-5">
                        <div class="text-head">
                            <h2>Personal loans up to $100,000</h2>
                            <h3>You’re more than just your score.</h3>
                        </div>
                        <form action="loan-form.php" method="post">
                            <div class="managerange">
                                ...
                                <div class="extra-controls form-inline">
                                    <div class="form-group">
                                        ...
                                        <span class="doller-style">$</span>
                                        <input type="text" name="income" class="js-input-to form-control" value="0" placeholder="Gross Monthly Income*" />
                                        <?php if (isset($successData)) {
                                        ?>
                                            <input type="hidden" name="code" value="<?php echo $successData['code']; ?>" />
                                        <?php } ?>
                                    </div>
                                </div>
                                <a class="get-started-btn" href="javascript:void(0)">Continue</a>
                            </div>
                        </form>
                    </div>
                </div>
                <div class="col-md-7">
                    <div class="banner-right">
                        <img src="img/loan.jpg" class="img-fluid mob-image">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 footer-left">
                    <div class="footer-head">
                        <h2>Lower your interest rate and save.</h2>
